Obj createHotel(Pts basicLine,Pts basicLineUp,Pts basicLineSlab,Pts basicLineSlabUp){
  Obj ruban = new Obj();
...
hotel.add(curveMidDown.pt(24));
    for(int i =195; i<=240; i+=16){
...
hotel.add(mid.pt(3));
for(int i = 0 ; i<3; i++)
    hotel.add(extUpGroup.line(1).pt(i));
hotel.add(mid.pt(4));
for(int i = 0 ; i<3; i++)
    hotel.add(curveDownGroup.line(2).pt(i));
hotel.add(curveMidDown.pt(5));
...
hotel1.add(curveMidDown.pt(5));


for(int i =43; i<=96; i+=16){
   hotel1.add( extDown.pt(i));
   hotel1.add( extDown.pt(i+1));
   hotel1.add( extDown.pt(i+2));
   hotel1.add( curveUniform.pt((i+5)%curveUniform.numOfPts()));
   hotel1.add( curveUniform.pt((i+8)%curveUniform.numOfPts()));
   hotel1.add( curveUniform.pt((i+9)%curveUniform.numOfPts()));
   hotel1.add( curveUniform.pt((i+10)%curveUniform.numOfPts()));
   hotel1.add( curveUniform.pt((i+13)%curveUniform.numOfPts()));
   }
 for(int i = 0 ; i<3; i++)
    hotel1.add(extDownGroup.line(6).pt(i));
hotel1.add(mid.pt(14));
for(int i = 0 ; i<3; i++)
    hotel1.add(curveUpGroup.line(7).pt(i));
    hotel1.add(mid.pt(15));
for(int i = 0 ; i<3; i++)
    hotel1.add(extDownGroup.line(7).pt(i));
    hotel1.add(curveMidDown.pt(16));
  
  for(int i = 0 ; i<3; i++)
    hotel1.add(curveDownGroup.line(8).pt(i));
  
  hotel2.add(curveMidDown.pt(16));
  
 for(int i =131; i<=160; i+=16){
   hotel2.add( curveUniform.pt(i));
   hotel2.add( curveUniform.pt(i+1));
   hotel2.add( curveUniform.pt(i+2));
   hotel2.add( curveUniform.pt((i+5)%curveUniform.numOfPts()));
   hotel2.add( extDown.pt((i+8)%curveUniform.numOfPts()));
   hotel2.add( extDown.pt((i+9)%curveUniform.numOfPts()));
   hotel2.add( extDown.pt((i+10)%curveUniform.numOfPts()));
   hotel2.add( curveUniform.pt((i+13)%curveUniform.numOfPts()));
   }
   for(int i = 0 ; i<3; i++)
    hotel2.add(curveDownGroup.line(10).pt(i));
     hotel2.add(curveMidDown.pt(21));
    for(int i = 0 ; i<3; i++)
    hotel2.add(extDownGroup.line(10).pt(i));  
   hotel2.add(mid.pt(22));
for(int i = 0 ; i<3; i++)
    hotel2.add(curveUpGroup.line(11).pt(i));
    hotel2.add(mid.pt(23));
for(int i = 0 ; i<3; i++)
    hotel2.add(extDownGroup.line(11).pt(i));
  
  hotel2.add(curveMidDown.pt(24));
for(int i = 0 ; i<3; i++)
