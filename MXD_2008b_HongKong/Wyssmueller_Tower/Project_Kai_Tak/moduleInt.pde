Obj createModuleInt(Pts basicLine,Pts basicLineUp,Pts basicLineSlab,Pts basicLineSlabUp){
  Obj ruban = new Obj();
  //////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////
 ...
 Slab1.add(curveMidUp.pt(1));
  ...
  Slab4.add(mid.pt(11));
  for(int i = 0 ; i<2; i++)
    Slab4.add(extDownGroup.line(5).pt(i));
  ruban.add(Slab4);
