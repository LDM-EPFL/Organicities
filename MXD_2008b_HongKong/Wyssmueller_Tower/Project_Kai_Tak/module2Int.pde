Obj createModule2Int(Pts basicLine,Pts basicLineUp,Pts basicLineSlab,Pts basicLineSlabUp){
  Obj ruban = new Obj();
  //////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////
 ...
 // ruban.add(curveUniform);
  ...
  for(int i = 1 ; i<3; i++)
    Slab1.add(curveDownGroup.line(1).pt(i));
    Slab1.add(mid2.pt(3));
   for(int i = 0 ; i<3; i++)
 ...
 Slab2.add(curveMidUp.pt(6));
  ...
  Pts Slab3 = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab3.add(curveUpGroup.line(6).pt(i));
   Slab3.add(mid2.pt(13)); 
  for(int i = 0 ; i<3; i++)
