Obj createHotel2Int(Pts basicLine,Pts basicLineUp,Pts basicLineSlab,Pts basicLineSlabUp){
  Obj ruban = new Obj();
...
for(int i=4; i<curveUniform.numOfPts(); i+=8)
    mid2.add(etageMid.line(i).pt(1));
...
Pts hotel2 = new Pts();
 ...
 hotel.add(curveMidDown.pt(27));
    
    for(int i =219; i<=240; i+=16){
...
hotel.add(mid2.pt(4));
for(int i = 0 ; i<3; i++)
    hotel.add(extUpGroup.line(2).pt(i));
    hotel.add(mid2.pt(6));
for(int i = 0 ; i<3; i++)
    hotel.add(extDownGroup.line(3).pt(i));
hotel.add(curveMidDown.pt(8));
for(int i = 0 ; i<2; i++)
    hotel.add(curveDownGroup.line(4).pt(i));
    
hotel1.add(curveMidDown.pt(8));
 for(int i =67; i<=112; i+=16){
   ...
   hotel1.add(mid2.pt(15)); 
   for(int i = 0 ; i<3; i++)
    hotel1.add(curveUpGroup.line(8).pt(i));
    hotel1.add(mid2.pt(17)); 
  for(int i = 0 ; i<3; i++)
    hotel1.add(curveDownGroup.line(9).pt(i));
    hotel1.add(curveMidDown.pt(19));
    for(int i = 0 ; i<3; i++)
    hotel1.add(extDownGroup.line(9).pt(i));
    
    hotel2.add(curveMidDown.pt(19));
    
for(int i =155; i<=168; i+=16){
...
for(int i = 0 ; i<3; i++)
   ...
   hotel2.add(mid2.pt(23)); 
   for(int i = 0 ; i<3; i++)
    hotel2.add(curveUpGroup.line(12).pt(i));
    hotel2.add(mid2.pt(25)); 
  for(int i = 0 ; i<3; i++)
    hotel2.add(curveDownGroup.line(13).pt(i));
   
   hotel2.add(curveMidDown.pt(27));
 for(int i = 0 ; i<3; i++)
    hotel2.add(extDownGroup.line(13).pt(i));
