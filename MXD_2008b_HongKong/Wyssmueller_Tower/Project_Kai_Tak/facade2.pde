Obj createFacade2(Pts basicLine,Pts basicLineUp,Pts basicLineSlab,Pts basicLineSlabUp){
  Obj ruban = new Obj();
  //////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////
  ...
  Pts Slab1 = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab1.add(extUpGroup.line(0).pt(i));
    Slab1.add(curveMidUp.pt(2));
    for(int i = 0 ; i<3; i++)
  ...
  for(int i = 1 ; i<3; i++)
    Slab1int.add(curveUpGroupD.line(0).pt(i));
    Slab1int.add(curveMidUp.pt(2));
    for(int i = 0 ; i<3; i++)
    Slab1int.add(intUpGroup.line(1).pt(i));
    Slab1int.add(mid.pt(3));
     for(int i = 0 ; i<2; i++)
    Slab1int.add(curveDownGroupD.line(1).pt(i));
  ruban.add(Slab1int);
  ...
  Pts Slab2 = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab2.add(curveUpGroup.line(4).pt(i));
  Slab2.add(mid.pt(9));
  for(int i = 0 ; i<2; i++)
 ...
 for(int i = 1 ; i<3; i++)
    Slab2int.add(intUpGroup.line(4).pt(i));
  Slab2int.add(mid.pt(9));
  for(int i = 0 ; i<2; i++)
    Slab2int.add(curveDownGroupD.line(4).pt(i));
  ruban.add(Slab2int);  
  ///////////////////////////////////////////////////////////////////////////

  Pts Slab3 = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab3.add(curveUpGroup.line(5).pt(i));
  Slab3.add(mid.pt(11));
  for(int i = 0 ; i<3; i++)
    Slab3.add(extDownGroup.line(5).pt(i));
    Slab3.add(curveMidDown.pt(12));
    for(int i = 1 ; i<3; i++)
    Slab3.add(curveDownGroup.line(6).pt(i));
    Slab3.add(mid.pt(13));
     for(int i = 0 ; i<2; i++)
...
///////////////////////////////////////////////////////////////////
  Pts Slab3int = new Pts();
   for(int i = 1 ; i<3; i++)
    Slab3int.add(intUpGroup.line(5).pt(i));
  Slab3int.add(mid.pt(11));
  for(int i = 0 ; i<3; i++)
    Slab3int.add(curveDownGroupD.line(5).pt(i));
    Slab3int.add(curveMidDown.pt(12));
    for(int i = 1 ; i<3; i++)
    Slab3int.add(intDownGroup.line(6).pt(i));
    Slab3int.add(mid.pt(13));
     for(int i = 0 ; i<2; i++)
    Slab3int.add(curveUpGroupD.line(6).pt(i));
  ruban.add(Slab3int);
///////////////////////////////////////////////////////////////////

  Pts Slab4 = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab4.add(extDownGroup.line(8).pt(i));
    Slab4.add(curveMidDown.pt(18));
    for(int i = 0 ; i<3; i++)
    Slab4.add(curveDownGroup.line(9).pt(i));
    Slab4.add(curveMidDown.pt(19));
    for(int i = 0 ; i<3; i++)
    Slab4.add(extDownGroup.line(9).pt(i));
    Slab4.add(curveMidDown.pt(20));
    for(int i = 0 ; i<3; i++)
    Slab4.add(curveDownGroup.line(10).pt(i));
   Slab4.add(mid.pt(21));
     for(int i = 0 ; i<2; i++)
    Slab4.add(extUpGroup.line(10).pt(i));
     ruban.add(Slab4);
    
/////////////////////////////////////////////////////////////////////////////
Pts Slab4int = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab4int.add(curveDownGroupD.line(8).pt(i));
    Slab4int.add(curveMidDown.pt(18));
    for(int i = 0 ; i<3; i++)
    Slab4int.add(intDownGroup.line(9).pt(i));
    Slab4int.add(curveMidDown.pt(19));
    for(int i = 0 ; i<3; i++)
    Slab4int.add(curveDownGroupD.line(9).pt(i));
    Slab4int.add(curveMidDown.pt(20));
    for(int i = 0 ; i<3; i++)
    Slab4int.add(intDownGroup.line(10).pt(i));
   Slab4int.add(mid.pt(21));
     for(int i = 0 ; i<2; i++)
    Slab4int.add(curveUpGroupD.line(10).pt(i));
  ruban.add(Slab4int);
///////////////////////////////////////////////////////////////////////////////

 Pts Slab5 = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab5.add(curveDownGroup.line(11).pt(i));
    Slab5.add(mid.pt(23));
  for(int i = 0 ; i<3; i++)
    Slab5.add(extUpGroup.line(11).pt(i));
    Slab5.add(curveMidUp.pt(24));
    for(int i = 0 ; i<2; i++)
    Slab5.add(curveUpGroup.line(12).pt(i));
   ruban.add(Slab5);
   
  ///////////////////////////////////////////////////////////////////////////////
   Pts Slab5int = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab5int.add(intDownGroup.line(11).pt(i));
    Slab5int.add(mid.pt(23));
  for(int i = 0 ; i<3; i++)
    Slab5int.add(curveUpGroupD.line(11).pt(i));
    Slab5int.add(curveMidUp.pt(24));
    for(int i = 0 ; i<2; i++)
    Slab5int.add(intUpGroup.line(12).pt(i));
   ruban.add(Slab5int);
    ///////////////////////////////////////////////////////////////////////////////
    
  Pts Slab6 = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab6.add(curveDownGroup.line(14).pt(i));
    Slab6.add(mid.pt(29));
  for(int i = 0 ; i<2; i++)
    Slab6.add(extUpGroup.line(14).pt(i));
     ruban.add(Slab6);
     
    Pts Slab6int = new Pts();
  for(int i = 1 ; i<3; i++)
    Slab6int.add(intDownGroup.line(14).pt(i));
    Slab6int.add(mid.pt(29));
  for(int i = 0 ; i<2; i++)
    Slab6int.add(curveUpGroupD.line(14).pt(i));
     ruban.add(Slab6int);
