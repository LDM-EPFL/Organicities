...
import processing.pdf.*; //pour exporter en pdf. (r)
boolean record;          
...
void setup() {
  ...
  Scale1 = new Param(.995,.8,1.005,"S1");
  Scale2 = new Param(.995,.8,1.005,"S2");
  Scale3 = new Param(1.0005,0.999,2,"S3");
